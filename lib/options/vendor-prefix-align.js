module.exports = (function() {
     ...
     */
    function extraIndentDecl(nodes, i) {
        var subset = [];
        while (i--) {
    ...
    return {
        ...
        process: function(nodeType, node) {
            ...
            walk({
                node: node,
                selector: getDeclName,
                getExtraSymbols: extraIndentDecl,
                payload: function(info, i) {
                    updateDict(info, dict, node[i][1]);
                }
            });
            ...
            walk({
                ...
                payload: function(info, i) {
                    ...
                    node[i][3][a - 1][1] = updateIndent(info, dict, valueNode[a - 1][1]);
                }
            });
        },
