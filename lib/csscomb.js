...
(function() {
     ...
     *
     * @param {String} [name='csscomb'] Config's name: 'csscomb', 'zen' or 'yandex'
     ...
     * @returns {Object|null}
     */
    Comb.getCustomConfig = function getCustomConfig(configPath) {
        var config;
        configPath = configPath || Comb.getCustomConfigPath();
     ...
     * @returns {String | null}
     */
    Comb.getCustomConfigPath = function getCustomConfigPath(configPath) {
        ...
        return Comb.getCustomConfigPath(configPath);
    };
